...
SLG_IO_PATH  := ../../../firmware/salagaio

CFLAGS      := -Wall -O0 -march=rv32i -mabi=ilp32 -static --specs=nosys.specs -I$(SLG_IO_PATH)
LDFLAGS     := -nostartfiles -T ../utils/linker-file.ld -lm -L$(SLG_IO_PATH) -lsalagaio
