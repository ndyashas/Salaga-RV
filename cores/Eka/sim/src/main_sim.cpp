...
int main(int argc, char **argv)
{
	...
	l1_inst_cache[20] = 0b00000010001100000000100110100011; // SB rs2(3) rs1(0) 51
	l1_inst_cache[21] = 0b00000010001100000001101100100011; // SH rs2(3) rs1(0) 54

	l1_inst_cache[22] = 0b00000000100000000000000011101111; // JAL rd(0) 8
	l1_inst_cache[23] = 0b00000000000000000000000000000000; // NOP
	l1_inst_cache[24] = 0b11111101010000001000010001100111; // JALR rd(8) -44(rs1(1)) // 1 holds 92. 92 minus 44 is 48, so 12 inst behind.
